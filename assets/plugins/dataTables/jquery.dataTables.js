...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var input = '<input type="search"  placeholder="Pencarian" class="'+classes.sFilterInput+'"/>';
	...
	DataTable.defaults = {
		 ...
		 * (i.e. "Melihat 1 to 10 of 57 entries") DataTables will render large numbers
		...
		"oLanguage": {
			 ...
			 *
			 *  @type string
			 *  @default Melihat _START_ to _END_ of _TOTAL_ entries
			 *
			 *  @dtopt Language
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "info": "Melihat page _PAGE_ of _PAGES_"
			 *        }
			 *      } );
			 *    } );
			 */
			"sInfo": "Melihat Data ke _START_ sampai _END_ dari _TOTAL_ Data",
			 ...
			 *  @type string
			 *  @default Melihat 0 to 0 of 0 entries
			 *
			 *  @dtopt Language
			 ...
			 *    } );
			 */
			"sInfoEmpty": "Melihat data ke 0 sampai 0 dari 0 data",
			 ...
			 *    } );
			 */
			"sInfoFiltered": "(Pencarian berdasarkan _MAX_ total data)",
			 ...
			 *    } );
			 */
			"sZeroRecords": "Tidak menemukan data sesuai keyword"
		},
	...
	DataTable.models.oSettings = {
		...
		"oFeatures": {
			...
			/**
			 * Table information element (the 'Melihat x of y records' div) enable
			 * flag.
			 * Note that this parameter will be set by the initialisation routine. To
			 * set a default use {@link DataTable.defaults}.
			 *  @type boolean
